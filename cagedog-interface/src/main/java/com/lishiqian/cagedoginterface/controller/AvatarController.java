package com.lishiqian.cagedoginterface.controller;


import com.lishiqian.cagedoginterface.params.AvatarParams;
...
//@RequestBody(required = false) AvatarParams avatarParams,
